...
public class PhepXOR {
    public static void main(String[] args) throws Exception {
        ...
        byte[] a = sv.requestData("B21DCCN699", "IpzA83kG");
        ...
        //c. Gửi
        sv.submitData("B21DCCN699", "IpzA83kG", maHoa);
    }
}
/*
[Mã câu hỏi (qCode): IpzA83kG].  Một chương trình (tạm gọi là RMI Server) cung cấp giao diện cho phép triệu gọi từ xa để xử lý dữ liệu nhị phân.
Giao diện từ xa:
